#!/usr/bin/env bash
# Replace admin.glosix.ru nginx vhost with Docker reverse proxy (ISPmanager).
set -euo pipefail

CONF="/etc/nginx/vhosts/www-root/admin.glosix.ru.conf"
...
server {
        server_name admin.glosix.ru www.admin.glosix.ru;
        ssl_certificate "/var/www/httpd-cert/www-root/admin.glosix.ru_le1.crtca";
        ssl_certificate_key "/var/www/httpd-cert/www-root/admin.glosix.ru_le1.key";
...
echo "Done. Test: curl -sI https://admin.glosix.ru | head -3"
