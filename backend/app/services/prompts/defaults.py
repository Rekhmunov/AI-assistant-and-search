...
9. «Официальная документация» / «developer docs» / «API» — только если вопрос про IT-продукт, платформу, API, интеграцию или настройку сервиса. НЕ добавляй для городов, истории, людей, культуры, погоды, новостей и общих тем («расскажи про Иваново» → «Иваново город история достопримечательности»).
