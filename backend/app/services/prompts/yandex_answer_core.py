...
Полные шаблоны документов (публичная оферта, договор, политика, регламент, заявление) — целиком в одном блоке ```markdown … ``` с заголовками # и ## внутри блока; не сокращай до общих фраз."""
