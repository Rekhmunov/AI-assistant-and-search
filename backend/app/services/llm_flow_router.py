...
- image_generate — пользователь просит нарисовать/сгенерировать ВИЗУАЛЬНОЕ изображение/картинку с нуля.
  Слова-маркеры: «нарисуй», «нарисуй картинку», «сгенерируй изображение», «сделай арт», «фото [объект]».
  НЕ использовать если: «сгенерируй текст/отчёт/таблицу/документ/список» — это chat или search_rag.
  НЕ использовать если прикреплены фото для редактирования (→ image_edit или image_compose).
