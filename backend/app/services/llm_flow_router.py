...
legal_document = true — запрос создать/составить/написать юридический документ (договор, оферту, соглашение, устав, приказ, заявление). false — если это поиск информации о документах, не создание.
...
Если прикреплено изображение (jpg/png/webp/heic — НЕ pdf):
  ...
  → всё остальное с изображением — см. блок «Вложения (фото/изображения)» выше.
