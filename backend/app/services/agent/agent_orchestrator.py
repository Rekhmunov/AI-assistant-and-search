...
- max_send_file {chat_id, instruction, format?} — сформировать и отправить файл в MAX (docx/pdf/xlsx/image). Только если пользователь явно просил отправить файл/документ/картинку
