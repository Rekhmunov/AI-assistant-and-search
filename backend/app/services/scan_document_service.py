...
_SCAN_PROMPT = (
    ...
    "If multiple documents are visible, process only the largest/most prominent one.\n"
    "2. ROTATE: Orient the document correctly based on the text direction — "
    "portrait for vertical text layout, landscape for horizontal. "
    "If the document is rotated at any angle, rotate it so text reads normally.\n"
    ...
    "5. CONTRAST: For text-only documents — white background, black text. "
    "For documents with color elements (logos, stamps, photos, colored text) — "
    "preserve original colors.\n"
    "6. FIDELITY: Preserve all text and details exactly as they appear in the original. "
    "Do not blur, smear, alter or invent any content. "
    "For handwritten documents, preserve the original handwriting exactly as written.\n"
